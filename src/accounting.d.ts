...
export declare class AccountManager<Account, Deposit extends GenericDeposit, LedgerType> {
    ...
    createAccountAddress(account: Identity<Account>, externalAddress: string, currency: number): Promise<Address>;
    getAccountAddresses(account: Identity<Account>): Promise<Address[]>;
    getAccountAddressMap(account: Identity<Account>): Promise<{
        [id: string]: Address;
    }>;
    getAccountAddressByCurrency(account: Identity<Account>, currency: number): Promise<Address[]>;
    getAccountByAddressString(externalAddress: string, currency: number): Promise<Account | undefined>;
    getAccountByAddressId(address: Identity<Address>): Promise<Account | undefined>;
    assignUnusedAddress(account: string, currency: number): Promise<Address | undefined>;
}
